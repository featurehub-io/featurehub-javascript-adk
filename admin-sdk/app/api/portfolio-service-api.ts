...
// @ts-ignore
import { CreatePortfolio } from '../models';
// @ts-ignore
...
export const PortfolioServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {CreatePortfolio} createPortfolio 
         ...
         */
        createPortfolio: async (createPortfolio: CreatePortfolio, includeGroups?: boolean, includeApplications?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'createPortfolio' is not null or undefined
            if (createPortfolio === null || createPortfolio === undefined) {
                throw new RequiredError('createPortfolio','Required parameter createPortfolio was null or undefined when calling createPortfolio.');
            }
            ...
            const needsSerialization = (typeof createPortfolio !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data =  needsSerialization ? JSON.stringify(createPortfolio !== undefined ? ObjectSerializer.serialize(createPortfolio, 'CreatePortfolio') : {}) : (createPortfolio || "");
         ...
         * @param {boolean} [includeGroups] Include groups for this this portfolio in results
         * @param {boolean} [includeApplications] Include applications for this portfolio in results
         * @param {boolean} [includeEnvironments] Include environments for the included applications this portfolio in results
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updatePortfolioOnOrganisation: async (portfolio: Portfolio, includeGroups?: boolean, includeApplications?: boolean, includeEnvironments?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'portfolio' is not null or undefined
            if (portfolio === null || portfolio === undefined) {
                throw new RequiredError('portfolio','Required parameter portfolio was null or undefined when calling updatePortfolioOnOrganisation.');
            }
            const localVarPath = `/mr-api/portfolio`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
...
export const PortfolioServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createPortfolio(createPortfolio: CreatePortfolio, includeGroups?: boolean, includeApplications?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Portfolio>> {
            const localVarAxiosArgs = await PortfolioServiceApiAxiosParamCreator(configuration).createPortfolio(createPortfolio, includeGroups, includeApplications, options);
         ...
         * @throws {RequiredError}
         */
        async updatePortfolioOnOrganisation(portfolio: Portfolio, includeGroups?: boolean, includeApplications?: boolean, includeEnvironments?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Portfolio>> {
            const localVarAxiosArgs = await PortfolioServiceApiAxiosParamCreator(configuration).updatePortfolioOnOrganisation(portfolio, includeGroups, includeApplications, includeEnvironments, options);
            return (axios: AxiosInstance = (configuration?.axiosInstance || globalAxios), basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
            };
...
export const PortfolioServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createPortfolio(createPortfolio: CreatePortfolio, includeGroups?: boolean, includeApplications?: boolean, options?: any): AxiosPromise<Portfolio> {
            return PortfolioServiceApiFp(configuration).createPortfolio(createPortfolio, includeGroups, includeApplications, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a portfolio
         * @param {string} id The id of the portfolio to find
         ...
         * @throws {RequiredError}
         */
        updatePortfolioOnOrganisation(portfolio: Portfolio, includeGroups?: boolean, includeApplications?: boolean, includeEnvironments?: boolean, options?: any): AxiosPromise<Portfolio> {
            return PortfolioServiceApiFp(configuration).updatePortfolioOnOrganisation(portfolio, includeGroups, includeApplications, includeEnvironments, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PortfolioServiceApi extends BaseAPI {
     ...
     */
    public createPortfolio(createPortfolio: CreatePortfolio, includeGroups?: boolean, includeApplications?: boolean, options?: any): AxiosPromise<Portfolio> {
        return PortfolioServiceApiFp(this.configuration).createPortfolio(createPortfolio, includeGroups, includeApplications, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PortfolioServiceApi
     */
    public updatePortfolioOnOrganisation(portfolio: Portfolio, includeGroups?: boolean, includeApplications?: boolean, includeEnvironments?: boolean, options?: any): AxiosPromise<Portfolio> {
        return PortfolioServiceApiFp(this.configuration).updatePortfolioOnOrganisation(portfolio, includeGroups, includeApplications, includeEnvironments, options).then((request) => request(this.axios, this.basePath));
    }
}
