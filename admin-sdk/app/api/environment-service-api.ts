...
export const EnvironmentServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createEnvironment: async (id: string, environment: Environment, options: any = {}): Promise<RequestArgs> => {
            ...
            if (environment === null || environment === undefined) {
                throw new RequiredError('environment','Required parameter environment was null or undefined when calling createEnvironment.');
            }
         ...
         * @throws {RequiredError}
         */
        deleteEnvironment: async (eid: string, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getEnvironment: async (eid: string, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, includeSdkUrl?: boolean, includeServiceAccounts?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'eid' is not null or undefined
            if (eid === null || eid === undefined) {
         ...
         * @throws {RequiredError}
         */
        updateEnvironment: async (eid: string, environment: Environment, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'eid' is not null or undefined
            if (eid === null || eid === undefined) {
...
export const EnvironmentServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createEnvironment(id: string, environment: Environment, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Environment>> {
            const localVarAxiosArgs = await EnvironmentServiceApiAxiosParamCreator(configuration).createEnvironment(id, environment, options);
         ...
         * @throws {RequiredError}
         */
        async deleteEnvironment(eid: string, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<boolean>> {
            const localVarAxiosArgs = await EnvironmentServiceApiAxiosParamCreator(configuration).deleteEnvironment(eid, includeAcls, includeFeatures, includeDetails, options);
            return (axios: AxiosInstance = (configuration?.axiosInstance || globalAxios), basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getEnvironment(eid: string, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, includeSdkUrl?: boolean, includeServiceAccounts?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Environment>> {
            const localVarAxiosArgs = await EnvironmentServiceApiAxiosParamCreator(configuration).getEnvironment(eid, includeAcls, includeFeatures, includeDetails, includeSdkUrl, includeServiceAccounts, options);
            return (axios: AxiosInstance = (configuration?.axiosInstance || globalAxios), basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateEnvironment(eid: string, environment: Environment, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Environment>> {
            const localVarAxiosArgs = await EnvironmentServiceApiAxiosParamCreator(configuration).updateEnvironment(eid, environment, includeAcls, includeFeatures, includeDetails, options);
            return (axios: AxiosInstance = (configuration?.axiosInstance || globalAxios), basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
            };
...
export const EnvironmentServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createEnvironment(id: string, environment: Environment, options?: any): AxiosPromise<Environment> {
            return EnvironmentServiceApiFp(configuration).createEnvironment(id, environment, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete an environment
         * @param {string} eid The id of the environment to find
         ...
         * @throws {RequiredError}
         */
        deleteEnvironment(eid: string, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, options?: any): AxiosPromise<boolean> {
            return EnvironmentServiceApiFp(configuration).deleteEnvironment(eid, includeAcls, includeFeatures, includeDetails, options).then((request) => request(axios, basePath));
        },
        /**
         * this api is designed to update the ordering of environments. it will error on circular references or environments that don\'t exist.
         * @param {string} id The id of the application to find
         ...
         * @throws {RequiredError}
         */
        getEnvironment(eid: string, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, includeSdkUrl?: boolean, includeServiceAccounts?: boolean, options?: any): AxiosPromise<Environment> {
            return EnvironmentServiceApiFp(configuration).getEnvironment(eid, includeAcls, includeFeatures, includeDetails, includeSdkUrl, includeServiceAccounts, options).then((request) => request(axios, basePath));
        },
        /**
         * Update an environment. Please use updateEnvironment2 as that has the fields that can actually be updated
         * @param {string} eid The id of the environment to find
         ...
         * @throws {RequiredError}
         */
        updateEnvironment(eid: string, environment: Environment, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, options?: any): AxiosPromise<Environment> {
            return EnvironmentServiceApiFp(configuration).updateEnvironment(eid, environment, includeAcls, includeFeatures, includeDetails, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class EnvironmentServiceApi extends BaseAPI {
     ...
     */
    public createEnvironment(id: string, environment: Environment, options?: any): AxiosPromise<Environment> {
        return EnvironmentServiceApiFp(this.configuration).createEnvironment(id, environment, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EnvironmentServiceApi
     */
    public deleteEnvironment(eid: string, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, options?: any): AxiosPromise<boolean> {
        return EnvironmentServiceApiFp(this.configuration).deleteEnvironment(eid, includeAcls, includeFeatures, includeDetails, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EnvironmentServiceApi
     */
    public getEnvironment(eid: string, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, includeSdkUrl?: boolean, includeServiceAccounts?: boolean, options?: any): AxiosPromise<Environment> {
        return EnvironmentServiceApiFp(this.configuration).getEnvironment(eid, includeAcls, includeFeatures, includeDetails, includeSdkUrl, includeServiceAccounts, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EnvironmentServiceApi
     */
    public updateEnvironment(eid: string, environment: Environment, includeAcls?: boolean, includeFeatures?: boolean, includeDetails?: boolean, options?: any): AxiosPromise<Environment> {
        return EnvironmentServiceApiFp(this.configuration).updateEnvironment(eid, environment, includeAcls, includeFeatures, includeDetails, options).then((request) => request(this.axios, this.basePath));
    }
}
