...
export const ApplicationServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createApplication: async (id: string, application: Application, includeEnvironments?: boolean, includeFeatures?: boolean, options: any = {}): Promise<RequestArgs> => {
...
export const ApplicationServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createApplication(id: string, application: Application, includeEnvironments?: boolean, includeFeatures?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Application>> {
            const localVarAxiosArgs = await ApplicationServiceApiAxiosParamCreator(configuration).createApplication(id, application, includeEnvironments, includeFeatures, options);
...
export const ApplicationServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createApplication(id: string, application: Application, includeEnvironments?: boolean, includeFeatures?: boolean, options?: any): AxiosPromise<Application> {
            return ApplicationServiceApiFp(configuration).createApplication(id, application, includeEnvironments, includeFeatures, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete an application
         * @param {string} appId The id of the application to find
...
export class ApplicationServiceApi extends BaseAPI {
     ...
     */
    public createApplication(id: string, application: Application, includeEnvironments?: boolean, includeFeatures?: boolean, options?: any): AxiosPromise<Application> {
        return ApplicationServiceApiFp(this.configuration).createApplication(id, application, includeEnvironments, includeFeatures, options).then((request) => request(this.axios, this.basePath));
    }
