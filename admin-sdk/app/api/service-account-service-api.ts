...
export const ServiceAccountServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createServiceAccountInPortfolio: async (id: string, serviceAccount: ServiceAccount, includePermissions?: boolean, options: any = {}): Promise<RequestArgs> => {
            ...
            if (serviceAccount === null || serviceAccount === undefined) {
                throw new RequiredError('serviceAccount','Required parameter serviceAccount was null or undefined when calling createServiceAccountInPortfolio.');
            }
         ...
         * @throws {RequiredError}
         */
        deleteServiceAccount: async (id: string, includePermissions?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
...
export const ServiceAccountServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createServiceAccountInPortfolio(id: string, serviceAccount: ServiceAccount, includePermissions?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceAccount>> {
            const localVarAxiosArgs = await ServiceAccountServiceApiAxiosParamCreator(configuration).createServiceAccountInPortfolio(id, serviceAccount, includePermissions, options);
         ...
         * @throws {RequiredError}
         */
        async deleteServiceAccount(id: string, includePermissions?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<boolean>> {
            const localVarAxiosArgs = await ServiceAccountServiceApiAxiosParamCreator(configuration).deleteServiceAccount(id, includePermissions, options);
            return (axios: AxiosInstance = (configuration?.axiosInstance || globalAxios), basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
            };
...
export const ServiceAccountServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createServiceAccountInPortfolio(id: string, serviceAccount: ServiceAccount, includePermissions?: boolean, options?: any): AxiosPromise<ServiceAccount> {
            return ServiceAccountServiceApiFp(configuration).createServiceAccountInPortfolio(id, serviceAccount, includePermissions, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete this service account, cascade removes all permissions
         * @param {string} id the id for the service account to get
         ...
         * @throws {RequiredError}
         */
        deleteServiceAccount(id: string, includePermissions?: boolean, options?: any): AxiosPromise<boolean> {
            return ServiceAccountServiceApiFp(configuration).deleteServiceAccount(id, includePermissions, options).then((request) => request(axios, basePath));
        },
        /**
         * Get service account by id or \'self\' if authenticated as this service account
         * @param {string} id the id for the service account to get
...
export class ServiceAccountServiceApi extends BaseAPI {
     ...
     */
    public createServiceAccountInPortfolio(id: string, serviceAccount: ServiceAccount, includePermissions?: boolean, options?: any): AxiosPromise<ServiceAccount> {
        return ServiceAccountServiceApiFp(this.configuration).createServiceAccountInPortfolio(id, serviceAccount, includePermissions, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ServiceAccountServiceApi
     */
    public deleteServiceAccount(id: string, includePermissions?: boolean, options?: any): AxiosPromise<boolean> {
        return ServiceAccountServiceApiFp(this.configuration).deleteServiceAccount(id, includePermissions, options).then((request) => request(this.axios, this.basePath));
    }
