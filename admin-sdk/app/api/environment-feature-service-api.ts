...
export const EnvironmentFeatureServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Delete a specific feature in this environment.
         * @param {string} eid The id of the environment to find features
         * @param {string} key The key of the relevant feature
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         ...
         * @throws {RequiredError}
         */
        getFeaturesForEnvironment: async (eid: string, filter?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'eid' is not null or undefined
            if (eid === null || eid === undefined) {
        ...
        /**
         * Update all features for this environment
         * @param {string} eid The id of the environment to find features or \&#39;latest\&#39;
...
export const EnvironmentFeatureServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getFeaturesForEnvironment(eid: string, filter?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EnvironmentFeaturesResult>> {
            const localVarAxiosArgs = await EnvironmentFeatureServiceApiAxiosParamCreator(configuration).getFeaturesForEnvironment(eid, filter, options);
            return (axios: AxiosInstance = (configuration?.axiosInstance || globalAxios), basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
            };
...
export const EnvironmentFeatureServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getFeaturesForEnvironment(eid: string, filter?: string, options?: any): AxiosPromise<EnvironmentFeaturesResult> {
            return EnvironmentFeatureServiceApiFp(configuration).getFeaturesForEnvironment(eid, filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Update all features for this environment
         * @param {string} eid The id of the environment to find features or \&#39;latest\&#39;
...
export class EnvironmentFeatureServiceApi extends BaseAPI {
     ...
     * @memberof EnvironmentFeatureServiceApi
     */
    public getFeaturesForEnvironment(eid: string, filter?: string, options?: any): AxiosPromise<EnvironmentFeaturesResult> {
        return EnvironmentFeatureServiceApiFp(this.configuration).getFeaturesForEnvironment(eid, filter, options).then((request) => request(this.axios, this.basePath));
    }
