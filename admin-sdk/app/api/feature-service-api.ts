...
// @ts-ignore
import { CreateFeature } from '../models';
// @ts-ignore
...
export const FeatureServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {CreateFeature} createFeature 
         * @param {boolean} [includeMetaData] Include the metadata in the returned feature objects. Can be large.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createFeaturesForApplication: async (id: string, createFeature: CreateFeature, includeMetaData?: boolean, options: any = {}): Promise<RequestArgs> => {
            ...
            // verify required parameter 'createFeature' is not null or undefined
            if (createFeature === null || createFeature === undefined) {
                throw new RequiredError('createFeature','Required parameter createFeature was null or undefined when calling createFeaturesForApplication.');
            }
            ...
            const needsSerialization = (typeof createFeature !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.data =  needsSerialization ? JSON.stringify(createFeature !== undefined ? ObjectSerializer.serialize(createFeature, 'CreateFeature') : {}) : (createFeature || "");
         ...
         * @param {string} id The id of the application to find
         * @param {Array<string>} [environmentIds] The environment ids to filter by. This should be limited to what the user is currently looking at or needing
         ...
         * @throws {RequiredError}
         */
        findAllFeatureAndFeatureValuesForEnvironmentsByApplication: async (id: string, environmentIds?: Array<string>, filter?: string, max?: number, page?: number, featureTypes?: Array<FeatureValueType>, sortOrder?: SortOrder, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
         ...
         * @param {Feature} feature 
         * @param {boolean} [includeMetaData] Include the metadata in the returned feature objects. Can be large.
         * @param {boolean} [returnAllFeatures] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateFeatureForApplicationOnFeature: async (id: string, feature: Feature, includeMetaData?: boolean, returnAllFeatures?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling updateFeatureForApplicationOnFeature.');
            }
            // verify required parameter 'feature' is not null or undefined
            if (feature === null || feature === undefined) {
                throw new RequiredError('feature','Required parameter feature was null or undefined when calling updateFeatureForApplicationOnFeature.');
            }
            const localVarPath = `/mr-api/application/{id}/features`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            ...
            if (returnAllFeatures !== undefined) {
                localVarQueryParameter['returnAllFeatures'] = returnAllFeatures;
            }
...
export const FeatureServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createFeaturesForApplication(id: string, createFeature: CreateFeature, includeMetaData?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Feature>>> {
            const localVarAxiosArgs = await FeatureServiceApiAxiosParamCreator(configuration).createFeaturesForApplication(id, createFeature, includeMetaData, options);
         ...
         * @throws {RequiredError}
         */
        async findAllFeatureAndFeatureValuesForEnvironmentsByApplication(id: string, environmentIds?: Array<string>, filter?: string, max?: number, page?: number, featureTypes?: Array<FeatureValueType>, sortOrder?: SortOrder, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApplicationFeatureValues>> {
            const localVarAxiosArgs = await FeatureServiceApiAxiosParamCreator(configuration).findAllFeatureAndFeatureValuesForEnvironmentsByApplication(id, environmentIds, filter, max, page, featureTypes, sortOrder, options);
            return (axios: AxiosInstance = (configuration?.axiosInstance || globalAxios), basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateFeatureForApplicationOnFeature(id: string, feature: Feature, includeMetaData?: boolean, returnAllFeatures?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Feature>>> {
            const localVarAxiosArgs = await FeatureServiceApiAxiosParamCreator(configuration).updateFeatureForApplicationOnFeature(id, feature, includeMetaData, returnAllFeatures, options);
            return (axios: AxiosInstance = (configuration?.axiosInstance || globalAxios), basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
            };
...
export const FeatureServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createFeaturesForApplication(id: string, createFeature: CreateFeature, includeMetaData?: boolean, options?: any): AxiosPromise<Array<Feature>> {
            return FeatureServiceApiFp(configuration).createFeaturesForApplication(id, createFeature, includeMetaData, options).then((request) => request(axios, basePath));
        },
        /**
         * updates all named features in this application, returns all features.
         * @param {string} id The id of the application to find
         ...
         * @throws {RequiredError}
         */
        findAllFeatureAndFeatureValuesForEnvironmentsByApplication(id: string, environmentIds?: Array<string>, filter?: string, max?: number, page?: number, featureTypes?: Array<FeatureValueType>, sortOrder?: SortOrder, options?: any): AxiosPromise<ApplicationFeatureValues> {
            return FeatureServiceApiFp(configuration).findAllFeatureAndFeatureValuesForEnvironmentsByApplication(id, environmentIds, filter, max, page, featureTypes, sortOrder, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a list of all environments and features and their values that this user has access to
         * @param {string} id The id of the application to find
         ...
         * @throws {RequiredError}
         */
        updateFeatureForApplicationOnFeature(id: string, feature: Feature, includeMetaData?: boolean, returnAllFeatures?: boolean, options?: any): AxiosPromise<Array<Feature>> {
            return FeatureServiceApiFp(configuration).updateFeatureForApplicationOnFeature(id, feature, includeMetaData, returnAllFeatures, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class FeatureServiceApi extends BaseAPI {
     ...
     */
    public createFeaturesForApplication(id: string, createFeature: CreateFeature, includeMetaData?: boolean, options?: any): AxiosPromise<Array<Feature>> {
        return FeatureServiceApiFp(this.configuration).createFeaturesForApplication(id, createFeature, includeMetaData, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FeatureServiceApi
     */
    public findAllFeatureAndFeatureValuesForEnvironmentsByApplication(id: string, environmentIds?: Array<string>, filter?: string, max?: number, page?: number, featureTypes?: Array<FeatureValueType>, sortOrder?: SortOrder, options?: any): AxiosPromise<ApplicationFeatureValues> {
        return FeatureServiceApiFp(this.configuration).findAllFeatureAndFeatureValuesForEnvironmentsByApplication(id, environmentIds, filter, max, page, featureTypes, sortOrder, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FeatureServiceApi
     */
    public updateFeatureForApplicationOnFeature(id: string, feature: Feature, includeMetaData?: boolean, returnAllFeatures?: boolean, options?: any): AxiosPromise<Array<Feature>> {
        return FeatureServiceApiFp(this.configuration).updateFeatureForApplicationOnFeature(id, feature, includeMetaData, returnAllFeatures, options).then((request) => request(this.axios, this.basePath));
    }
}
