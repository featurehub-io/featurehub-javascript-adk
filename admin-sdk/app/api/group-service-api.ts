...
export const GroupServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createGroup: async (id: string, createGroup: CreateGroup, includePeople?: boolean, options: any = {}): Promise<RequestArgs> => {
            ...
            if (createGroup === null || createGroup === undefined) {
                throw new RequiredError('createGroup','Required parameter createGroup was null or undefined when calling createGroup.');
            }
            ...
            localVarRequestOptions.data =  needsSerialization ? JSON.stringify(createGroup !== undefined ? ObjectSerializer.serialize(createGroup, 'CreateGroup') : {}) : (createGroup || "");
         ...
         * @throws {RequiredError}
         */
        updateGroupOnPortfolio: async (id: string, group: Group, includePeople?: boolean, includeMembers?: boolean, includeGroupRoles?: boolean, updateMembers?: boolean, updateEnvironmentGroupRoles?: boolean, updateApplicationGroupRoles?: boolean, applicationId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling updateGroupOnPortfolio.');
            }
            // verify required parameter 'group' is not null or undefined
            if (group === null || group === undefined) {
                throw new RequiredError('group','Required parameter group was null or undefined when calling updateGroupOnPortfolio.');
            }
            const localVarPath = `/mr-api/portfolio/{id}/group`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const GroupServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createGroup(id: string, createGroup: CreateGroup, includePeople?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Group>> {
            const localVarAxiosArgs = await GroupServiceApiAxiosParamCreator(configuration).createGroup(id, createGroup, includePeople, options);
            return (axios: AxiosInstance = (configuration?.axiosInstance || globalAxios), basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateGroupOnPortfolio(id: string, group: Group, includePeople?: boolean, includeMembers?: boolean, includeGroupRoles?: boolean, updateMembers?: boolean, updateEnvironmentGroupRoles?: boolean, updateApplicationGroupRoles?: boolean, applicationId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Group>> {
            const localVarAxiosArgs = await GroupServiceApiAxiosParamCreator(configuration).updateGroupOnPortfolio(id, group, includePeople, includeMembers, includeGroupRoles, updateMembers, updateEnvironmentGroupRoles, updateApplicationGroupRoles, applicationId, options);
            return (axios: AxiosInstance = (configuration?.axiosInstance || globalAxios), basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
            };
...
export const GroupServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createGroup(id: string, createGroup: CreateGroup, includePeople?: boolean, options?: any): AxiosPromise<Group> {
            return GroupServiceApiFp(configuration).createGroup(id, createGroup, includePeople, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a group
         * @param {string} gid The id of the group to find
         ...
         * @throws {RequiredError}
         */
        updateGroupOnPortfolio(id: string, group: Group, includePeople?: boolean, includeMembers?: boolean, includeGroupRoles?: boolean, updateMembers?: boolean, updateEnvironmentGroupRoles?: boolean, updateApplicationGroupRoles?: boolean, applicationId?: string, options?: any): AxiosPromise<Group> {
            return GroupServiceApiFp(configuration).updateGroupOnPortfolio(id, group, includePeople, includeMembers, includeGroupRoles, updateMembers, updateEnvironmentGroupRoles, updateApplicationGroupRoles, applicationId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GroupServiceApi extends BaseAPI {
     ...
     * @memberof GroupServiceApi
     */
    public createGroup(id: string, createGroup: CreateGroup, includePeople?: boolean, options?: any): AxiosPromise<Group> {
        return GroupServiceApiFp(this.configuration).createGroup(id, createGroup, includePeople, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GroupServiceApi
     */
    public updateGroupOnPortfolio(id: string, group: Group, includePeople?: boolean, includeMembers?: boolean, includeGroupRoles?: boolean, updateMembers?: boolean, updateEnvironmentGroupRoles?: boolean, updateApplicationGroupRoles?: boolean, applicationId?: string, options?: any): AxiosPromise<Group> {
        return GroupServiceApiFp(this.configuration).updateGroupOnPortfolio(id, group, includePeople, includeMembers, includeGroupRoles, updateMembers, updateEnvironmentGroupRoles, updateApplicationGroupRoles, applicationId, options).then((request) => request(this.axios, this.basePath));
    }
}
